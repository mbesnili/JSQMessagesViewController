...
*/
+ (nullable JSQMessagesAvatarImage *)avatarImageWithPlaceholder:(UIImage *)placeholderImage diameter:(NSUInteger)diameter;
 ...
 *  @return An initialized `JSQMessagesAvatarImage` object if created successfully, `nil` otherwise.
 */
+ (nullable JSQMessagesAvatarImage *)avatarImageWithImage:(UIImage *)image diameter:(NSUInteger)diameter;
 ...
 */
+ (nullable UIImage *)circularAvatarImage:(UIImage *)image withDiameter:(NSUInteger)diameter;
 ...
 *  @return A new image object if successful, `nil` otherwise.
 */
+ (nullable UIImage *)circularAvatarHighlightedImage:(UIImage *)image withDiameter:(NSUInteger)diameter;
 ...
 */
+ (nullable JSQMessagesAvatarImage *)avatarImageWithUserInitials:(NSString *)userInitials
